...
/**
 * REST controller for managing {@link com.badals.admin.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")
public class ShipmentResource {
    ...
    private static final String ENTITY_NAME = "adminShipment";
...
/*    @GetMapping("/_search/shipments")
    public List<ShipmentDTO> searchShipments(@RequestParam String query) {
